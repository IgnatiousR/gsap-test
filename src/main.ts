...
<main>
      ...
      <section class="container">
        ...
        <ul>
          ...
          <li>
            <a href="pages/16_timeline-preloader-demo-challenge/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Timeline Preloader</h3>
                <p>
          ...
          <li>
            <a href="pages/21_teh-tarik-final-pin-demo-challenge/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Final Pin Challenge</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/22_basic-text-entrance/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Basic Text Entrance</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/23_word-by-word-reveal/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Word-by-Word Reveal</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/24_character-reveal/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Character-by-Character Reveal</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/25_mask-line-reveal/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Masked Line Reveal</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/26_horizontal-mask-reveal/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Horizontal Mask Reveal</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/27_stack-text-reveal/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Stacked Text Reveal</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/28_number-counter/index.html">
              <img src="cover20.png" alt="animation-cover" />
          ...
          <li>
            <a href="pages/29_word-by-word-reveal-splitText/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Word-by-Word Reveal (SplitText)</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/30_ch-reveal-splitText/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Character-by-Character Reveal (SplitText)</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/31_line-by-line-splitText/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Masked Line Reveal (SplitText)</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/32_revert-SplitText/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>REVERT (SplitText)</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/33_autosplit-resplit/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Responsive SplitText with autoSplit + onSplit</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/34_loop-text-demo/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Looping Text Demo</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/35_font-stretch-demo/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Font Stretch Demo</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/36_echo-text-demo/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Echo Text Animation Demo</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/37_basic-scramble-usage/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Basic Scramble Animation</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/38_scramble-config/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>ScrambleText Plugin Config</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/39_scramble-behaviour/index.html">
              <img src="cover20.png" alt="animation-cover" />
          ...
          <li>
            <a href="pages/40_variable-font-animation/index.html">
              <img src="cover20.png" alt="animation-cover" />
          ...
          <li>
            <a href="pages/41_scroll-based-text-demo/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Scroll Based Text Animation</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
          ...
          <li>
            <a href="pages/42_vd-scroll-demo/index.html">
              <img src="cover20.png" alt="animation-cover" />

              <div>
                <h3>Scroll Video Demo</h3>
                <p>
                  Take control of scroll-driven motion by mastering scrub
                  animations, real-time updates, and scroll-linked timing using
                  GSAP ScrollTrigger.
